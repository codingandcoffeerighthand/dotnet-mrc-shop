...
internal class InitialData
{
    ...
    public static IEnumerable<Domain.Models.Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("mehmet", "ozkaya", "Bahcelievler No:4", "P1", "Turkey", "Istanbul", "38050", "mehmet@gmail.com");
            var address2 = Address.Of("john", "doe", "Broadway No:1", "P2", "England", "Nottingham", "08050", "john@gmail.com");
